...
- **Sélection de checklists** : Choix manuel ou automatique d'une checklist de conformité (ex. fiches CEE). Fichiers principaux : `front/src/pages/app/SelectChecklistPage.tsx`, `front/src/features/checklists/`.
